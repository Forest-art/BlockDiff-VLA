...
def get_default_beso_and_env(train_folder=None, dataset_path=None, checkpoint=None, env=None, lang_embeddings=None, device_id=0, eval_cfg_overwrite={},cfg=None):
    #train_cfg_path = Path(train_folder) / ".hydra/config.yaml"
    #train_cfg_path = format_sftp_path(train_cfg_path)
    #train_cfg_path = '/home/disk2/gyj/hyccode/Video-Prediction-Policy/conf/calvin_evaluate.yaml'
